...
//Asing armithmetic operators to express the combination
const a = 5 + 5;
const b = 80 / 2;
const c = 40 - 1;
// These set the values for  a, b, and c using arithmetic operators to get the combination code

//send a message to the user that expresses the combination
alert(`You have received this message because you have been chosen to open an important vault. Here is the secret combination: ${a} ${b} ${c}`);
// This creates a message telling the user the message and combination
